...
var WindowsPtyAgent = /** @class */ (function () {
    function WindowsPtyAgent(file, args, env, cwd, cols, rows, debug, _useConpty, conptyInheritCursor) {
        ...
        if (this._useConpty) {
            if (!conptyNative) {
                try {
                    conptyNative = require(prebuild_file_path_1.winConPtyPath || '../build/Release/conpty.node');
                }
                catch (outerError) {
                    try {
            ...
            if (!winptyNative) {
                try {
                    winptyNative = require(prebuild_file_path_1.winPtyPath || '../build/Release/pty.node');
                }
                catch (outerError) {
                    try {
