...
var prebuild_loader_1 = require("./prebuild-loader");
var DEFAULT_FILE = 'sh';
...
var UnixTerminal = /** @class */ (function (_super) {
    ...
    function UnixTerminal(file, args, opt) {
        ...
        // fork
        var term = prebuild_loader_1.default.fork(file, args, parsedEnv, cwd, _this._cols, _this._rows, uid, gid, (encoding === 'utf8'), onexit);
